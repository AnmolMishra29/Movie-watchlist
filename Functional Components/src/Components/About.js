...
export default function About() {
  return (
    ...
    <div className='aboutpage '>
      ...
      <p className="shadow1">
        The code is present at : <a href='https://github.com/AnmolMishra29/Movie-watchlist' target='_blank' rel="noreferrer" > <img src="	https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white" alt="Github Badge" style={{ borderRadius: '17px' }} /> </a>
      ...
      <div className="shawdow1">
        ...
        <div align="center">
          <div>
            <a href="mailto:mishraanmol534@gmail.com" target="_blank" rel="noreferrer" >
            ...
            <a href="https://www.linkedin.com/in/anmol-mishra-1a0364196" target="_blank" rel="noreferrer">
            ...
            <a href='https://github.com/AnmolMishra29/' target='_blank' rel="noreferrer" > 
      ...
      <h5 style={{textAlign:'center'}} className="shadow1">Made with <span style={{color: "#e25555"}}>&hearts;</span> | Coded by Anmol Mishra</h5>
      <hr />
    </div>
  </div>
  )
